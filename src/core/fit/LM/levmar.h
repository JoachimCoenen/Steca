...
/* This part was added to delegate member function pointer to this interface */
...
#ifdef LM_DBL_PREC
typedef FastDelegate5<double* /*parameter list*/, double* /*y values*/, int /*number of parameter*/, int /*number of data points*/, void*> DelegateCalculationDbl;
/* double precision LM, with & without Jacobian */
/* unconstrained minimization */
extern int dlevmar_der(
      DelegateCalculationDbl*,
      DelegateCalculationDbl*,
...
#ifdef LM_SNGL_PREC
typedef FastDelegate5<float* /*parameter list*/, float* /*y values*/, int /*number of parameter*/, int /*number of data points*/, void*> DelegateCalculationSngl;
/* single precision LM, with & without Jacobian */
/* unconstrained minimization */
extern int slevmar_der(
      DelegateCalculationSngl*,
      DelegateCalculationSngl*,
...
#ifdef LM_DBL_PREC
extern int eAx_eq_b_QR(double *A, double *B, double *x, int m);
extern int eAx_eq_b_QRLS(double *A, double *B, double *x, int m, int n);
extern int eAx_eq_b_Chol(double *A, double *B, double *x, int m);
extern int eAx_eq_b_LU(double *A, double *B, double *x, int m);
extern int eAx_eq_b_SVD(double *A, double *B, double *x, int m);
extern int eAx_eq_b_BK(double *A, double *B, double *x, int m);
...
#ifdef LM_SNGL_PREC
extern int tAx_eq_b_QR(float *A, float *B, float *x, int m);
extern int tAx_eq_b_QRLS(float *A, float *B, float *x, int m, int n);
extern int tAx_eq_b_Chol(float *A, float *B, float *x, int m);
extern int tAx_eq_b_LU(float *A, float *B, float *x, int m);
extern int tAx_eq_b_SVD(float *A, float *B, float *x, int m);
extern int tAx_eq_b_BK(float *A, float *B, float *x, int m);
